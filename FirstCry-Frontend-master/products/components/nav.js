let navbar = () =>{
    ...
    <div class="fc_search">
        <form class="headSearchBox">
            <input type="text" name="" id="search_box" autocomplete="off" placeholder="Search for a Category, Brand or Product">
    ...
    <div class="fc_login">
       <ul>
        ...
        <li id="userName"><span>Login /</span><span> Register</span></li>
        <li><i class="fa-regular fa-heart"></i><span>  Shortlist</span></li>
        <li class="midicon" id="cartBtn"><i class="fa-solid fa-cart-shopping"></i></i><span id="cart_c"></span> <span id="productNo"></span></li>
       </ul>
    </div>
    </div>
    </div>
